...
## September 11, 2026 — Forest light, contact and GPU instance updates
...
Original flight samples cover opening, ridge, valley, lake, close grove, waterfall, summit/coast and all content directions at both sizes. Desktop route samples are approximately two seconds apart, compact three seconds; content holds and stationary samples have wider gaps. Unobserved frames are not certified. Final-held grove/waterfall samples retain stable contact and changing leaf/water phases, without visible solid crown chips; foliage grain and ribbon-like falling water remain. No formal held-out material was used.
...
Human 45–55% equivalence with 95% CI, physical devices, thermal behavior and delivery remain unverified. The initial structural acceptance criterion is PARTIAL, not closed by the smaller lighting/contact result.
...
## September 12, 2026 — Valley hollows and branching groves

Connected eastern valley hollows, triangle-grounded plants and authored branch/leaf crowns address landform and vegetation structure together. Crown-size grove spacing replaces packed source rows while retaining original root coordinates. The treatment transfers across valley, lake, riparian, bank canopy, understory and source bank; desktop shadows and prior canopy light/contact remain active. No new external asset; one bank GLB and its embedded dependencies leave the request path.

The strongest gain is readable branch structure near the bank; ridge exit, valley, lake and waterfall show more consistent groves, with a modest landform gain. The larger realism objective remains partial. Sparse hillsides, airy crowns, residual planting regularity, weak atmosphere, smooth water margins and the ribbon-like fall remain. A established, B earliest unmet, C and D incomplete.

Rejected/superseded: inaccurate analytic grounding (up to 1.6244 m error), bright regular branch tiers, bank-only coverage, uniform broad transfer and size variation without layout correction. Corrected grounding is below 0.000002 m in the sampled actual meshes. Final geometry joins modeled leaf bases to branch centerlines; a shadow-casting flag was corrected before the final evaluation. Intermediate compact timeouts were traced to grounding notifications restarting Suspense terrain construction. Publication now happens after terrain commit, with repeated compact-load regression checks. Failure captures are retained.

Fixed budgets, exact source/provider/alias, final still/motion coverage, visitor checks, local/public costs and remaining failures are recorded in the [publication receipt](../../output/releases/madagin-valley-structure-20260912/publication.json), [visual review](../../output/releases/madagin-valley-structure-20260912/visual-review.json), [matrix](../../output/releases/madagin-valley-structure-20260912/quality-matrix.json) and [decision](../../output/releases/madagin-valley-structure-20260912/decision.json). Rollback d229a322 / dpl_7wY6EqiSceeXdv2j9FV4K3GFvT99. Human equivalence, physical devices, thermal behavior and mailbox/delivery remain unverified.
