...
try {
 for(const width of [390,1440])for(const held of ['terrain','ecology']){
  ...
  const asset=held==='ecology'?'**/world/v116/ecology-ridge-v1.16.json':width===390?'**/world/v116/terrain-ridge-v1.16.glb':'**/world/v115/madagin-ridge-to-valley-high-v1.15.glb';
  ...
  try{
   ...
   await page.waitForTimeout(500);assert.ok(pending>0);
